<?php 
	...
	if (isset($_POST['simpan'])) {
		...
		$sql = "UPDATE sertifikasi SET nip='$nip', nama='$nama', jabatan='$jabatan' , unit='$unit', kode_sertifikasi='$kode', judul_sertifikasi='$judul', pelaksana='$pelaksana', no_sertifikasi='$nomor', masa_berlaku='$masa', sampai_dengan='$sampai' WHERE id='$id'";			
		mysqli_query($db, $sql);
